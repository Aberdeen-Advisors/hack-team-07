...
window.BRIDGE_DATA =  {
  ...
  items: [
    ...
    {id:'r1', kind:'Blocker', urg:'High', title:'Partner team to provide open-item details — unblocks the workflow test', owner:'SP', sev:'R', reviewed:null, status:'open', due:'2026-08-10', note:'Consent, procedures, exception handling, and update triggers all still outstanding. Being chased.', src:{kind:'transcript', docId:'buildtrans'}, verification:{status:'verified',decidedBy:'seeded',decidedAt:null,note:'Typed into the tracker by a person before Bridge existed.'}},
    {id:'r2', provenance:{"sourceSystem": "transcript", "docId": "buildtrans", "line": 7, "author": "Sam Prentice", "messageTs": "2026-08-06 14:03 ET", "permalink": null, "quote": "Roughly a third of the 14,500 records in the initial load read as potential duplicates.", "confidence": "high"}, kind:'Risk', urg:'High', title:'Record load duplicate matching — roughly a third of 14,500 records read as duplicates', owner:'SP', sev:'R', reviewed:null, status:'open', note:'Proposed workaround is a provisional-record workflow: hold the load, work the duplicates, then finalize. Internal decision still pending.', src:{kind:'transcript', docId:'buildtrans'}, verification:{status:'pending',decidedBy:null,decidedAt:null,note:'Extracted from a transcript by Bridge. No person has checked it.'}},
    {id:'r3', provenance:{"sourceSystem": "transcript", "docId": "comptrans", "line": 11, "author": "Jordan Chen", "messageTs": "2026-08-04 16:15 ET", "permalink": null, "quote": "One risk worth recording — the review committee meets monthly, and the realistic slot is the ninth of November rather than the twenty-sixth of October.", "confidence": "high"}, meetingId:'compws', kind:'Risk', urg:'High', title:'Onboarding timeline is the main risk to the end-of-November go-live', owner:'JC', sev:'R', reviewed:null, status:'open', note:'The review committee meets monthly. Nov 9 is more realistic than Oct 26, which pushes past the planned go-live date.', verification:{status:'pending',decidedBy:null,decidedAt:null,note:'Extracted from a transcript by Bridge. No person has checked it.'}},
