...
window.BRIDGE_DATA =  {
  ...
  recurring:[
    ...
    {id:'leadstrat', name:'Leadership Strategy Sync (internal)', dow:5, time:'3:30 ET', cadence:'weekly', ws:'lead', owner:'Alex Rivera', audience:'Program leads only, no vendor present', purpose:'Internal leadership sync. On hold pending a scheduling follow-up.', deliverables:[]}
  ],
  ...
  items: [
    /* — Alex Rivera (@arivera) — */
    {id:'a1', kind:'Action', urg:'High', title:'Send the approved Finance & Billing deck to attendees ahead of the call', owner:'AR', due:'2026-08-10', status:'open', deliv:{mid:'fincyc'}, note:'Deck reviewed and approved. Requested to go out before the call, by end of day if possible.', src:{kind:'slack', url:'#'}},
    {id:'a2', kind:'Action', urg:'High', title:'Chase the partner team on outstanding contract signatures', owner:'AR', due:'2026-08-10', status:'open', note:'No-show at the 8/3 steering call. Overdue from 8/4, in progress.'},
    {id:'a3', kind:'Action', urg:'High', title:'Finalize the Compliance V1 deck — add standards slides plus a decisions-needed slide', owner:'AR', due:'2026-08-10', status:'open', deliv:{mid:'compws'}, note:'Overdue from 8/4, in progress.', src:{kind:'transcript', docId:'comptrans'}},
    {id:'a4', kind:'Action', urg:'High', title:'Present the system build timeline at the 8/17 leadership deliverable review', owner:'AR', due:'2026-08-24', status:'open', note:'Sequence: individual meetings, deep dive, timeframes and dependencies, partner overlay, align, present.', src:{kind:'transcript', docId:'buildtrans'}},
    {id:'a5', kind:'Action', urg:'Med', title:'Send the consolidated project plan to the partner team for validation and discrepancy review', owner:'AR', due:'2026-08-24', status:'open', note:'From the 8/4 morning standup.'},
    {id:'a6', kind:'Action', urg:'Med', title:'Confirm who owns taking the integration to the Change Advisory Board', owner:'AR', due:'2026-08-24', status:'open', deliv:{mid:'itmgr'}, note:'Raised as a deliverable gap on the delivery leadership call.'},
    {id:'a7', kind:'Action', urg:'Med', title:'Add a support and ticketing section to the leadership status — who receives tickets after go-live', owner:'AR', due:'2026-08-24', status:'open', deliv:{mid:'itmgr'}, note:'Leadership status deliverable, still unowned.'},
    {id:'a8', kind:'Action', urg:'Med', title:'Merge the consolidated project plan with the partner implementation team plan', owner:'AR', due:'2026-08-24', status:'open', note:'Loop the partner implementation team into the relevant workstream meetings going forward.', src:{kind:'transcript', docId:'steertrans'}},
    {id:'a9', kind:'Action', urg:'Low', title:'Confirm the steering committee roster on the delivery side', owner:'AR', due:'2026-08-24', status:'open', note:'Is a technical executive sponsor needed beyond the current list?'},
    {id:'a10', kind:'Action', urg:'High', title:'Build the steering deck timeline slide, date-anchored to an end-of-November phase 1 go-live', owner:'AR', due:'2026-08-24', status:'done', deliv:{mid:'steer'}, note:'Completed 2026-08-07. Go-live anchor confirmed as end of November 2026, superseding the prior early-November back-plan. v4 posted as a lean four-slide pack.'},

    /* — Jordan Chen (@jchen) — */
    {id:'a11', kind:'Action', urg:'High', title:'Book a session with the onboarding team to start standard enrollment immediately', owner:'JC', due:'2026-08-10', status:'open', deliv:{mid:'compws'}, note:'The delegated path is off. With only 34 partner staff, standard individual onboarding starts now, so there is no agreement to wait on.'},
    {id:'a12', kind:'Action', urg:'High', title:'Send the partner team the exact onboarding document list and get a review meeting booked', owner:'JC', due:'2026-08-11', status:'open', note:'From the 8/7 steering transcript.', src:{kind:'transcript', docId:'steertrans'}},
    {id:'a13', kind:'Action', urg:'Med', title:'Confirm delegated-approval agreement legal review status and return the signed agreement', owner:'JC', due:'2026-08-24', status:'open', note:'Due end of week.'},
    {id:'a14', kind:'Action', urg:'Med', title:'Roll the week of action-item updates into the steering Next Steps slide', owner:'JC', due:'2026-08-17', status:'open', deliv:{mid:'steer'}, note:'Folded into the per-workstream next-steps slide.'},
    {id:'a15', kind:'Action', urg:'Low', title:'Schedule a training-environment walkthrough of the flagged workflows for the clinical reviewers', owner:'JC', due:'2026-08-24', status:'open', note:'Screen-out versus refer-out logic needs a live demo.'},
    {id:'a16', kind:'Action', urg:'Med', title:'Second-pass review of the consolidated project plan draft', owner:'JC', due:'2026-08-24', status:'done', note:'Completed 2026-08-06 with feedback from all three workstream leads folded in.'},

    /* — Sam Prentice (@sprentice) — */
    {id:'a17', kind:'Action', urg:'High', title:'Resubmit the failed test message using a known-good provider record and notify the workflow tester', owner:'SP', due:'2026-08-10', status:'open', note:'Workaround while partner identity records are unresolved.', src:{kind:'transcript', docId:'buildtrans'}},
    {id:'a18', kind:'Action', urg:'High', title:'Confirm partner records exist in the target system with correct identifiers', owner:'SP', due:'2026-08-10', status:'open', note:'Records team to create them if missing. Production intent, which removes the test workaround.'},
    {id:'a19', kind:'Action', urg:'Med', title:'Walk through the partner workflow to test message triggers', owner:'SP', due:'2026-08-24', status:'open', note:'Blocked on the partner delivering the open-item steps.'},
    {id:'a20', kind:'Action', urg:'Med', title:'Share the combined interface script tracker with the partner team', owner:'SP', due:'2026-08-10', status:'open', deliv:{mid:'wqreview0812'}, note:'Due 8/12 ahead of the work queue review.'},
    {id:'a21', kind:'Action', urg:'Med', title:'Locate and document the record-matching weight configuration; confirm the weighting is adequate', owner:'SP', due:'2026-08-24', status:'open', note:'From the 8/6 interface review.'},
    {id:'a22', kind:'Action', urg:'Med', title:'Determine viable test-run count per script given the partner email and phone reuse limit', owner:'SP', due:'2026-08-10', status:'open', note:'Overdue from 8/5.'},
    {id:'a23', kind:'Action', urg:'Med', title:'Confirm that partner-sourced documents render as expected in the customer portal', owner:'SP', due:'2026-08-24', status:'open', note:'From the 8/6 interface review.'},
    {id:'a24', kind:'Action', urg:'Low', title:'Clarify the release-of-information process for partner-sourced documents', owner:'SP', due:'2026-08-24', status:'open', note:'Confirm scope with the vendor. May need a separate statement of work.'},

    /* — Morgan Keller (@mkeller) — */
    {id:'a25', kind:'Action', urg:'High', title:'Lock the second weekly slot for Workflow Design & Build', owner:'MK', due:'2026-08-11', status:'open', note:'Target is twice weekly per the 7/23 decision. Waiting on availability from two leads.'},
    {id:'a26', kind:'Action', urg:'Med', title:'Schedule the cutover and go-live review after the 8/11 testing sessions', owner:'MK', due:'2026-08-12', status:'open', note:'Cutover to be treated as a named deliverable, not an event.'},
    {id:'a27', kind:'Action', urg:'Med', title:'Stand up a 15-minute weekly all-group status call', owner:'MK', due:'2026-08-24', status:'open', note:'Deferring one to two weeks until there is enough to report. Target roughly 8/24.'},
    {id:'a28', kind:'Action', urg:'Med', title:'Update meeting dates on steering deck slide 3', owner:'MK', due:'2026-08-24', status:'done', deliv:{mid:'steer'}, note:'Completed 2026-08-07. Slide 3 stays as an overview; dates moved to the timeline slide.'},
    {id:'a29', kind:'Action', urg:'Low', title:'Confirm whether the 8/12 session is the last testing round before change control', owner:'MK', due:'2026-08-24', status:'open', note:'From the 8/5 standup.'},

    /* — Unassigned — */
    {id:'a30', kind:'Action', urg:'Med', title:'Fill the open operations program manager seat', owner:'Unassigned', due:'2026-08-24', status:'open', note:'Two new partner-side PM seats are open: operations PM and technical PM.'},
    {id:'a31', kind:'Action', urg:'Med', title:'Send over the onboarding documentation already on hand for the 34 partner staff', owner:'Unassigned', due:'2026-08-24', status:'open', note:'Speeds the partner packet build. Due end of week.'},

    /* — RISKS, BLOCKERS, ISSUES — */
    {id:'r1', kind:'Blocker', urg:'High', title:'Partner team to provide open-item details — unblocks the workflow test', owner:'SP', sev:'R', reviewed:null, status:'open', due:'2026-08-10', note:'Consent, procedures, exception handling, and update triggers all still outstanding. Being chased.', src:{kind:'transcript', docId:'buildtrans'}},
    {id:'r2', kind:'Risk', urg:'High', title:'Record load duplicate matching — roughly a third of 14,500 records read as duplicates', owner:'SP', sev:'R', reviewed:null, status:'open', note:'Proposed workaround is a provisional-record workflow: hold the load, work the duplicates, then finalize. Internal decision still pending.', src:{kind:'transcript', docId:'buildtrans'}},
    {id:'r3', kind:'Risk', urg:'High', title:'Onboarding timeline is the main risk to the end-of-November go-live', owner:'JC', sev:'R', reviewed:null, status:'open', note:'The review committee meets monthly. Nov 9 is more realistic than Oct 26, which pushes past the planned go-live date.'},
    {id:'r4', kind:'Risk', urg:'Med', title:'Partner workflow spec unclear — which configuration triggers a status message', owner:'SP', sev:'Y', reviewed:null, status:'open', note:'Behavior on a return interaction within 24 hours versus after is still open. Blocks workflow testing.'},
    {id:'r5', kind:'Risk', urg:'Med', title:'Test-record coverage limit — the partner system requires a unique email and phone per record', owner:'SP', sev:'Y', reviewed:null, status:'open', note:'The tester may be out of test emails and phone numbers, capping coverage.'},
    {id:'r6', kind:'Risk', urg:'Med', title:'Analytics licensing caps at 4 seats — over-dependent on a single partner-side SME', owner:'MK', sev:'Y', reviewed:null, status:'open', note:'Additional seats run $6,200 per year each. Plan is to add no-license raw-data access for an internal team member as redundancy.'},
    {id:'r7', kind:'Risk', urg:'Med', title:'Stale project tracker still circulating', owner:'AR', sev:'Y', reviewed:null, status:'open', note:'Do not use as-is. The consolidated project plan is canonical. Watching.'},
    {id:'r8', kind:'Risk', urg:'Low', title:'Deck versioning slip — an old version was shared on 8/3', owner:'JC', sev:'Y', reviewed:null, status:'open', note:'Always share the active version going forward. Watching.'},
    {id:'i1', kind:'Issue', urg:'Med', title:'Document format needs sign-off — section order differs from the house standard', owner:'SP', sev:'Y', reviewed:null, status:'open', note:'Asks on record: remove the dead link, fix the confusing prior-interaction reference, and reorder the summary block to the top.'},

    /* — DECISIONS — */
    {id:'d1', kind:'Decision', urg:'High', title:'Phase 1 go-live anchored to end of November 2026', owner:'Team', date:'Aug 7', note:'Confirmed on both sides. Supersedes the earlier early-November back-plan. All timeline slides now key off this date.'},
    {id:'d2', kind:'Decision', urg:'High', title:'Delegated approval path is off — standard individual onboarding starts now', owner:'Team', date:'Aug 4', note:'With only 34 partner staff, the delegated agreement is not worth the wait. Individual onboarding begins immediately.'},
    {id:'d3', kind:'Decision', urg:'Med', title:'Two-week sprint cadence for phase 1', owner:'Team', date:'Aug 5', note:'Chosen over three weeks so there are two full review points before go-live.'},
    {id:'d4', kind:'Decision', urg:'Med', title:'Steering deck rebuilt as a lean four-slide pack', owner:'Team', date:'Aug 3', note:'Title, Focus, Workstream Overview, Two-Sprint Timeline. The old week-by-week slide and the appendix were dropped rather than extended.'},
    {id:'d5', kind:'Decision', urg:'Med', title:'Workflow design sessions split into pre-launch and post-launch groups', owner:'Team', date:'Jul 30', note:'Group 1 covers pre-launch design, Group 2 covers post-launch. Both run weekly.'},
    {id:'d6', kind:'Decision', urg:'Low', title:'The consolidated project plan is the canonical source for milestones', owner:'Team', date:'Jul 28', note:'The older tracker is archived. Any milestone question resolves against the consolidated plan.'},
    {id:'d7', kind:'Decision', urg:'Low', title:'Program renamed from "Revenue Systems" to "Platform Consolidation"', owner:'Team', date:'Aug 7', note:'Clarified at steering. The old name understated the scope. All decks updated.'},
    {id:'d8', kind:'Decision', urg:'Low', title:'Cutover treated as a named deliverable with an owner', owner:'Team', date:'Aug 6', note:'Previously tracked as an event with no owner, which is how it kept slipping.'}
  ],
